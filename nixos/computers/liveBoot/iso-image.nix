  ...
  buildMenuAdditionalParamsGrub2 =
    ...
    menuBuilderGrub2 finalCfg [
      ...
      }
      {
        name = "gateway";
        class = "installer";
        params = "init=${config.system.build.toplevel}/specialisation/gateway/init ${additional} ${toString config.boot.kernelParams}";
      }
      {
        name = "gateway (copytoram)";
        class = "copytoram";
        params = "init=${config.system.build.toplevel}/specialisation/gateway/init ${additional} ${toString config.boot.kernelParams} copytoram";
      }
    ];
